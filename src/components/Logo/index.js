...
export const Logo = (props) => {
  return (
    <Svg
      width={385.458}
      height={120.81}
      viewBox="57.271 14.595 385.458 120.81"
      style={{
        background: "0 0",
      }}
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor="#0010ff" stopOpacity={0.8} />
          <stop offset={0.5} stopColor="#120812" stopOpacity={0.9} />
          <stop offset={1} stopColor="#f02" />
        </linearGradient>
        <filter id="prefix__editing-halftone">
          <feFlood result="color" floodColor="red" />
          <feImage
            xlinkHref="data:image/svg+xml;base64,"
            width={1000}
            height={1000}
            result="image"
          />
